...
describe("safe error conversion", () => {
  ...
  it.each([
    ...
    [{ source: "job", issue: "missing" } as const, "job_not_found"],
    [{ source: "job", issue: "invalid" } as const, "job_invalid"],
    [{ source: "job", issue: "busy" } as const, "job_busy"],
    [{ source: "job", issue: "disabled" } as const, "job_disabled"],
    [{ source: "job", issue: "already-running" } as const, "job_already_running"],
    [{ source: "job", issue: "script-roots" } as const, "job_script_roots_unavailable"],
    [{ source: "job", issue: "script-invalid" } as const, "job_script_invalid"],
    [{ source: "job", issue: "script-unavailable" } as const, "job_script_unavailable"],
    [{ source: "job", issue: "pre-run" } as const, "job_pre_run_failed"],
    [{ source: "job", issue: "post-run" } as const, "job_post_run_failed"],
    [{ source: "job", issue: "hook-timeout" } as const, "job_hook_timeout"],
    [{ source: "job", issue: "hook-output" } as const, "job_hook_output_limit"],
    [{ source: "job", issue: "prompt" } as const, "job_prompt_failed"],
    [{ source: "job", issue: "aborted" } as const, "job_aborted"],
    [{ source: "job", issue: "interrupted" } as const, "job_interrupted"],
