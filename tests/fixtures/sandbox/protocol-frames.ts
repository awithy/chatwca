export const validParentFrames: readonly unknown[] = [
  { type: "hello", protocol: 1, nonce: "n".repeat(16), artifactSha256: "a".repeat(64), artifactVersion: "1", hiddenPaths: [], mountPaths: [], exitAfterProbe: false, commandTimeoutMs: 900_000, maxCommandOutputBytes: 67_108_864 },
...
export const invalidParentFrames: readonly unknown[] = [
  ...
  { type: "hello", protocol: 2, nonce: "n".repeat(16), artifactSha256: "a".repeat(64), artifactVersion: "1", hiddenPaths: [], mountPaths: [], exitAfterProbe: false, commandTimeoutMs: 900_000, maxCommandOutputBytes: 67_108_864 },
];
